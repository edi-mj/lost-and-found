...
<div class="pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <div class="flex">
                        <div class="ml-3">
                            <p class="text-sm text-yellow-700">
                                <strong>Tips:</strong> Upload foto asli atau foto barang sejenis biar orang lebih gampang mengenalinya.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
            ...
            <form action="{{ route('reports.lost.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div id='drop-zone' class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md relative hover:bg-gray-50 transition">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div id="image-preview" class="hidden mb-4 relative w-fit mx-auto">
                                        ...
                                        <button type="button" onclick="removeImage()" class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full p-1 shadow-md hover:bg-red-600 focus:outline-none transition-colors duration-200" title="Hapus foto">
